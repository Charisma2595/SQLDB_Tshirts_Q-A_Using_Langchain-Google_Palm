...
This is an end to end LLM project based on Google Palm and Langchain. Am building a system that can talk to MySQL database. 
...
- I built an LLM based question and answer system that uses the following,
  - Google Palm LLM
